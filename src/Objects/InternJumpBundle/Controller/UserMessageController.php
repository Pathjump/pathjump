...
class UserMessageController extends Controller {
    ...
    public function messagesBoxAction($box, $page = 1) {
        ...
        return $this->render('ObjectsInternJumpBundle:Message:user_box.html.twig', array(
                    'page' => $page,
    ...
    public function getMessagesAction($box, $page, $itemsPerPage) {
        ...
        return $this->render('ObjectsInternJumpBundle:Message:user_messages.html.twig', array(
                    'page' => $page,
                    'itemsPerPage' => $itemsPerPage,
                    'count' => $count,
    ...
    public function messagesBatchAction() {
        ...
        if (!$messagesId || count($messagesId) == 0) {
            ...
            return $this->redirect($this->generateUrl('user_box', array('box' => $box)));
        }
    ...
    public function getMessageAction($id) {
        ...
        return $this->render('ObjectsInternJumpBundle:Message:user_message.html.twig', array(
                    'entity' => $entity,
    ...
    public function deleteAction($id) {
        ...
        return $this->redirect($this->generateUrl('user_messages', array('box' => 'inbox')));
    }
    ...
    public function newMessageFormAction($userName = NULL) {
        ...
        return $this->render('ObjectsInternJumpBundle:Message:user_new.html.twig', array(
                    'entity' => $entity,
    ...
    public function createAction($userName = NULL) {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('show_user_message', array('id' => $entity->getId())));
            }
        }
        return $this->render('ObjectsInternJumpBundle:Message:user_new.html.twig', array(
                    'entity' => $entity,
