...
class CVController extends Controller {
    ...
    public function signupCVAction() {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            if ($form->isValid()) {
                ...
                return $this->redirect($this->generateUrl('signup_cv_skills'));
            }
        }
        return $this->render('ObjectsInternJumpBundle:CV:signup_cv.html.twig', array(
    ...
    public function editCVEmloymentHistoryAction($id) {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            return $this->redirect($this->generateUrl('user_portal_home', array('loginName' => $user->getLoginName(), 'cvId' => $entity->getId())));
        }
        return $this->render('ObjectsInternJumpBundle:CV:cv_employment_histories.html.twig', array(
                    'entity' => $entity,
    ...
    public function editCVSkillsAction($id) {
        ...
        if ($request->getMethod() == 'POST') {
            ...
            //check if we are in a cv create wizard
            if ($request->getSession()->has('cvCreate')) {
                return $this->redirect($this->generateUrl('cv_employment_history', array('id' => $entity->getId())));
            }
        }
        return $this->render('ObjectsInternJumpBundle:CV:cv_skills.html.twig', array(
                    'entity' => $entity,
