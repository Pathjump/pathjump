...
class QuizAdmin extends Admin {
     ...
     * @var string 
     */
    protected $baseRouteName = 'quiz_admin';

    /**
     * this variable holds the url route prefix for this actions
     * @var string 
     */
    protected $baseRoutePattern = 'quiz';
    ...
    public function configureFormFields(FormMapper $formMapper) {
        $formMapper
                ...
                ->add('answers', 'sonata_type_collection', array('required' => false), array(
                    'edit' => 'inline',
                    'inline' => 'table'
                ))
                ->end()
    ...
    public function preUpdate($entity) {
        ...
        $entity->setRequiredData();
    }

    /**
     * this function will be executed before the create of any new object
     * @author Mahmoud
     */
